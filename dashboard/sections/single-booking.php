        ...
        <div class="header-content">
            ...
            <div class="header-actions">
                <?php if ($booking->status === 'pending') : ?>
                    <button type="button" class="btn-action btn-confirm" data-booking-id="<?php echo $booking->id; ?>">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <?php elseif ($booking->status === 'confirmed') : ?>
                    <button type="button" class="btn-action btn-complete" data-booking-id="<?php echo $booking->id; ?>">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2ZM8 12l2 2 4-4"/>
                        </svg>
                        <?php _e('Mark Complete', 'mobooking'); ?>
                    </button>
                <?php endif; ?>
                
                <?php if (in_array($booking->status, ['pending', 'confirmed'])) : ?>
                    <button type="button" class="btn-action btn-cancel" data-booking-id="<?php echo $booking->id; ?>">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"/>
                            <path d="M15 9l-6 6M9 9l6 6"/>
                        </svg>
                        <?php _e('Cancel Booking', 'mobooking'); ?>
                    </button>
                <?php endif; ?>
