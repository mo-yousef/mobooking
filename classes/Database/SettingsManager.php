...
class SettingsManager {
     ...
     * Delete settings
     */
    public function delete_settings($user_id) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
     ...
     */
    public function get_settings_for_user($user_id) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
     ...
     */
    public function get_settings_for_all_users() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
    ...
    /**
     * Get settings for a specific user by company name
     */
    public function get_settings_by_company_name($company_name) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
     ...
     */
    public function get_settings_by_email($email) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
    ...
    /**
     * Get settings for a specific user by phone
     */
    public function get_settings_by_phone($phone) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
    ...
    /**
     * Get settings for a specific user by logo URL
     */
    public function get_settings_by_logo_url($logo_url) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE logo_url = %s",
            $logo_url
        ));
    }
    /**
     * Get settings for a specific user by primary color
     */

    public function get_settings_by_primary_color($primary_color) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE primary_color = %s",
            $primary_color
        ));
    }
    /**
     * Get settings for a specific user by email header
     */
    public function get_settings_by_email_header($email_header) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE email_header = %s",
            $email_header
        ));
    }
    
    /**
     * Get settings for a specific user by email footer
     */
    public function get_settings_by_email_footer($email_footer) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE email_footer = %s",
            $email_footer
        ));
    }
    /**
     * Get settings for a specific user by terms and conditions
     */
    public function get_settings_by_terms_conditions($terms_conditions) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE terms_conditions = %s",
            $terms_conditions
        ));
    }
    /**
     * Get settings for a specific user by booking confirmation message
     */
    public function get_settings_by_booking_confirmation_message($booking_confirmation_message) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mobooking_settings';
        
        return $wpdb->get_row($wpdb->prepare(
            "SELECT * FROM $table_name WHERE booking_confirmation_message = %s",
            $booking_confirmation_message
        ));
    }
    /**
     * Get settings for a specific user by user ID
     */
